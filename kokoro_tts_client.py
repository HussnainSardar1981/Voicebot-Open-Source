...
class KokoroTTSClient:
    ...
    def __init__(self, voice_name="af_sarah"):
        try:
            ...
            # 🎵 AUDIO QUALITY SETTINGS - Match RIVA's enhanced speech settings
            self.audio_quality = {
            ...
            logger.info(f"Kokoro TTS Client initialized with voice: {voice_name}")
